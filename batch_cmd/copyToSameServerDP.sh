...
do
	scp qchen@csr$i.comp.hkbu.edu.hk:/tmp/qchen/database/$1.dp.$i.dat qchen@csr69.comp.hkbu.edu.hk:/tmp/qchen/database/
	scp qchen@csr$i.comp.hkbu.edu.hk:/tmp/qchen/database/$1.dp.$i.idx qchen@csr69.comp.hkbu.edu.hk:/tmp/qchen/database/
