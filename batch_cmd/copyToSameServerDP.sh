...
do
	scp qchen@csr$i.comp.hkbu.edu.hk:/tmp/qchen/database/NE.dp.$i.dat qchen@csr69.comp.hkbu.edu.hk:/tmp/qchen/database/NE.dp.$i.dat
	scp qchen@csr$i.comp.hkbu.edu.hk:/tmp/qchen/database/NE.dp.$i.idx qchen@csr69.comp.hkbu.edu.hk:/tmp/qchen/database/NE.dp.$i.idx
