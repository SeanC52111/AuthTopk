...
do
	scp qchen@csr$i.comp.hkbu.edu.hk:/tmp/qchen/database/NE.dl.$i.dat qchen@csr69.comp.hkbu.edu.hk:/tmp/qchen/database/NE.dl.$i.dat
	scp qchen@csr$i.comp.hkbu.edu.hk:/tmp/qchen/database/NE.dl.$i.idx qchen@csr69.comp.hkbu.edu.hk:/tmp/qchen/database/NE.dl.$i.idx
